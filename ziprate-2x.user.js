// ==UserScript==
// @name         ⚡ ZipRate: Stealth Speed Controller (2x Default)
// @namespace    http://tampermonkey.net/
// @version      1.4
// @description  Persistent speed control and stealth mode (tricks site focus) with a safe, temporary fullscreen-compatible HUD. Starts at 2.0x.
...
(function() {
    ...
    console.log("⚡ ZipRate (2x): Initializing (Stealth Mode Active)...");
