// ==UserScript==
// @name         ⚡ ZipRate: Stealth Speed Controller (1x Default)
// @namespace    http://tampermonkey.net/
// @version      1.4
// @description  Persistent speed control and stealth mode (tricks site focus) with a safe, temporary fullscreen-compatible HUD. Starts at 1.0x.
...
(function() {
    ...
    console.log("⚡ ZipRate (1x): Initializing (Stealth Mode Active)...");
